...
import { IDChangePasswordFormModalComponent } from 'src/app/shared/modal/id-change-password/id-change-password.component';
...
export class IDChangePasswordComponent implements OnInit, OnDestroy {
  isLoading: boolean;
        ...
        .pipe(
          ...
          switchMap(() => {
            ...
            return this.baseService.getUserRequest(
              ...
              this.pageSize,
              this.searchText,
              Constants.PasswordChangeRequest,
              this.payload
            );
          }),
          map((response: any) => {
  ...
  editView(data) {
    const dialogRef = this.dialog.open(IDChangePasswordFormModalComponent, {
      height: '100%',
      width: '50%',
      position: {
        top: '0px',
