...
import { IDCreationFormModalComponent } from 'src/app/shared/modal/id-creation-form-modal/id-creation-form-modal.component';
...
@Component({
    ...
    styleUrls: ['./id-creation.component.scss'],
    animations: [
...
export class IDCreationComponent implements OnInit, OnDestroy {
    isLoading: boolean;
    ...
    editView(data) {
        const dialogRef = this.dialog.open(IDCreationFormModalComponent, {
            height: '100%',
            width: '50%',
            position: {
                top: '0px',
