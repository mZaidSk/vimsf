...
@Component({
  selector: 'app-work-sheet-file',
  templateUrl: './work-sheet-file.component.html',
  styleUrls: ['./work-sheet-file.component.scss'],
})
export class WorkSheetFileComponent implements OnInit, OnDestroy {
  form: FormGroup;
  isLoading: boolean;
      ...
      merge(this.paginator.page)
        .pipe(
          ...
          switchMap(() => {
            ...
            return this.baseService.getWorkSlotFileList(
